...
const DIVISIONS = [
  {
    ...
    titleKey: "home.division1.title" as const,
    descKey: "home.division1.desc" as const,
    href: "/building",
  },
  {
    image: "/datacc.png",
    titleKey: "home.division2.title" as const,
    descKey: "home.division2.desc" as const,
    href: "/telecom",
  },
  {
    image: "/gdsolar.png",
    titleKey: "home.division3.title" as const,
    descKey: "home.division3.desc" as const,
    href: "/solar",
  },
];
    ...
    <div className="relative w-full min-h-screen bg-white text-slate-900 font-sans antialiased selection:bg-indigo-200">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 pt-16 md:pt-24 pb-20 flex flex-col items-center text-center">
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center gap-4">
          ...
          >
            <Link href="/contact">{t("home.cta2")}</Link>
          </Button>
        </div>
